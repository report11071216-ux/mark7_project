  ...
  return (
    <button
      ...
      className={cn(
        ...
        "shadow-[0_0_24px_rgba(88,101,242,0.4)] hover:shadow-[0_0_32px_rgba(88,101,242,0.7)]",
    ...
    >
      <div className="relative z-10 flex items-center justify-center gap-3">
        {loading ? (
          ...
          <>
            <svg className="w-6 h-6" viewBox="0 0 71 55" fill="currentColor" aria-hidden="true">
