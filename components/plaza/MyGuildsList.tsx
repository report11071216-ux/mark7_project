        ...
        {guilds.length === 0 ? (
          ...
          guilds.map((g) => (
            <Link
              key={g.id}
              href={`/guild/${g.code}`}
              className="group block p-2 rounded-lg hover:bg-sky-50 transition-colors"
            >
              <div className="flex items-center gap-2">
                {g.logo_url ? (
                  ...
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-sky-500 to-sky-300 flex items-center justify-center shrink-0">
