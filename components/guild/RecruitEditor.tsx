...
export default function RecruitEditor({ guildCode, initial }: Props) {
  ...
  const inputClass =
    "w-full px-3 py-2 rounded-lg border border-slate-200 text-sm text-slate-900 placeholder:text-slate-400 bg-white focus:outline-none focus:ring-2 focus:ring-violet-300";
