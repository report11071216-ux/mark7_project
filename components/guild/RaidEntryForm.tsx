    ...
    <div className="max-w-xl mx-auto px-4 md:px-6 py-6 pb-24 md:pb-6">
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold text-white">레이드 등록</h1>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="space-y-2">
            {[
              { label: "노말", value: goldNormal, set: setGoldNormal, color: "text-zinc-300" },
              { label: "하드", value: goldHard, set: setGoldHard, color: "text-violet-300" },
              { label: "나이트메어", value: goldNightmare, set: setGoldNightmare, color: "text-rose-300" },
            ].map((g) => (
              <div key={g.label} className="flex items-center gap-2">
                ...
                <input
                  ...
                  placeholder="0"
                  inputMode="numeric"
                  className="flex-1 h-10 px-3 rounded-lg bg-card/60 ring-1 ring-border text-sm text-white placeholder:text-muted-foreground focus:ring-2 focus:ring-violet-500 outline-none"
                />
