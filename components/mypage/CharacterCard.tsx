...
export default function CharacterCard({
  ...
  return (
    <div className="relative w-full rounded-2xl overflow-hidden bg-zinc-950 border border-amber-500/20 shadow-[0_8px_40px_rgba(245,158,11,0.12)]">
      {/* 골드 상단 라인 */}
