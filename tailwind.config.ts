...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
  fontFamily: {
  sans: ["var(--font-jakarta)", "var(--font-pretendard)", "system-ui", "sans-serif"],
  mono: ["var(--font-jetbrains)", "ui-monospace", "monospace"],
  display: ["var(--font-jakarta)", "var(--font-pretendard)", "system-ui", "sans-serif"],
},
      colors: {
      ...
      backgroundImage: {
        "aurora":
          "radial-gradient(ellipse 80% 50% at 50% -20%, hsl(263 70% 50% / 0.3), transparent), radial-gradient(ellipse 50% 50% at 80% 50%, hsl(189 94% 43% / 0.15), transparent)",
        "grid-violet":
          "linear-gradient(to right, hsl(263 70% 50% / 0.05) 1px, transparent 1px), linear-gradient(to bottom, hsl(263 70% 50% / 0.05) 1px, transparent 1px)",
        "noise":
        ...
        "shimmer":
          "linear-gradient(110deg, transparent 40%, rgba(167,139,250,0.4) 50%, transparent 60%)",
      },
      backgroundSize: {
        "grid-violet": "32px 32px",
      },
      boxShadow: {
        "glow-violet": "0 0 24px hsl(263 70% 50% / 0.4)",
        "glow-cyan": "0 0 24px hsl(189 94% 43% / 0.4)",
        "card-violet": "0 8px 32px -8px hsl(263 70% 50% / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
